...
const API_SECRET = process.env.API_SECRET || "parthchopra111:secret:682cd1534b134c94a6ace85173b7a740"; // Replace with your API secret
const API_KEY = process.env.API_KEY || "parthchopra111:public:df0b984f997f4f09b2607bb88d1fc546"; // this will be injected to index.html
...
app.get("", (req, res) => {
    ...
    fs.readFile(index, 'utf8', function(err, data) {
        ...
        var result = data.replace(/parthchopra111:public:df0b984f997f4f09b2607bb88d1fc546/g, API_KEY);
        res.send(result);
    });
});
