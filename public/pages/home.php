<div class="page page-home light">
	...
	<div class="page-content content-area pt-40">
		...
		<div class="container">
				...
				<div class="swiper-wrapper" style="height:250px;">
					<div class="swiper-slide">
						<div class="card-bx featured-card">
							...
							<div class="card-info">
								...
								<p class="location">Theory - BVSD 33</p>
					...
					<div class="swiper-slide">
						<div class="card-bx featured-card">
							...
							<div class="card-info">
								<h5 class="title"><a href="/syllabus/">Web Programming</a></h5>
								<p class="location"> Theory- BVSD 34</p>
								<h6 class="text-primary vacancy">Syllabus</h6>
							</div>
						</div>
					</div>
					<div class="swiper-slide">
						<div class="card-bx featured-card color-theme-red">
							...
							<div class="card-info">
								<h5 class="title"><a href="/syllabus/">OS - II</a></h5>
								<p class="location">Theory- BVSD 34</p>
								<h6 class="text-primary vacancy">Syllabus</h6>
							</div>
						</div>
					...
					<div class="swiper-slide">
						<div class="card-bx featured-card">
							...
							<div class="card-info">
								<h5 class="title"><a href="/syllabus/">Networking & Internet</a></h5>
								<p class="location">Theory- BVSD 35</p>
								<h6 class="text-primary vacancy">Syllabus</h6>
							</div>
						</div>
					</div>
			...
			<button onclick="this.setAttribute('theme', this.getAttribute('theme') === 'dark' ? 'light' : 'dark')" class="button col button-round">Dark Mode</button>
