	...
	<div class="page-content content-area pt-40">
		...
		<div class="container">
			...
			<div class="list search-list searchbar-found dz-list mt-0 mb-30">
				...
				$query = "SELECT * FROM `subject` WHERE ltc_incharge='".$_SESSION['name']."'";
				...
				if ($result->num_rows > 0) 
			{
				...
				while($row = $result->fetch_assoc())
				{
				   ...
				   <a href="/teacher-lecture/?ltc_id='. $id.'"><div class="card-bx job-card">
						   <div class="card-media color-theme  ">
							   <a href="/teacher-lecture/?ltc_id='. $id. '"><i  style="font-size: 36px;" class="fa fa-graduation-cap"></i></a>
						   </div>
						   <div class="card-info">
							   <h6 class="item-title"><a href="/teacher-lecture/?ltc_id='. $id. '">'.$_SESSION['ltc_name'].'</a></h6>
