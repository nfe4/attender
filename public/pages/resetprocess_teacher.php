<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $query    = "INSERT into `reset_teacher` (`fname`,`lname`,`username`,`email`, `tstamp`)
                     VALUES (  '$fname','$lname','$username','$email', '$create_datetime')";
        ...
        if ($result) {
          ...
          <h5 class="custom-file-label text-primary">'.$fname, $lname.'</h5>
          <h5>'.$username.' </h5>
